...
const ThankYouPage = async ({searchParams}: PageProps) => {
    ...
    return (
        <main className='relative lg:min-h-full'>
            <div className='hidden md-block h-40 overflow-hidden lg:absolute lg:h-full lg:w-1/2 lg:pr-4 xl:pr-12'>
                <Image 
                    fill src="/checkout-thank-you.jpg"
            ...
            <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:grid lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:py-32 xl:gap-x-24">
                <div className="lg:col-start-2">
                    <h1 className="text-sm font-medium text-green-600">Order successful</h1>
                </div>
                ...
                <div className='mt-16 text-sm font-medium'>
                    ...
                    <ul className='mt-6 divide-y divide-gray-200 border0t border-gray-200 text-sm font-medium text-muted-foreground'>
                        {(
                    ...
                    <div className='space-y-6 border-t border-gray-200 pt-6 text-sm font-medium text-muted-foreground'>
                        ...
                        <div className="flex items-center justify-betweeen border-t border-gray-200 pt-6">
                    ...
                    <div className="mt-16 border-t border-gray-200 py-6 text-right">
                        <Link href="/products" className="text-sm font-medium text-green-600 hover:text-blue-500">
